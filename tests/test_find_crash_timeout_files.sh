...
mkdir "$AFL_DIR/crashes/id:directory"
ln -s "$AFL_DIR/crashes/id:000000,sig:11,src:000" "$AFL_DIR/crashes/id:symlink"
find_crash_timeout_files | assert_count 2 "afl-single crash regular files only"
